...
| **Frontend Framework** | **React 18** | Component-based UI structure |
| **Build Tool** | **Vite + SWC** | Fast development & optimized builds |
...
| **Styling** | **Tailwind CSS** | Utility-first styling with custom variables |
| **UI Components** | **shadcn/ui + Radix UI** | Accessible, themeable component system |
| **Notifications** | **sonner + toaster** | Toast & alert components for UX feedback |
